...
namespace Wakatime::Internal
{
    ...
    WakaOptions::WakaOptions(QObject *parent) : QObject(parent), _wakatimeCFG(QDir::homePath() + QDir::separator() + ".wakatime.cfg")
    {
        read();
    }
    ...
    bool WakaOptions::isDebug() const
    {
        return _isDebug;
    }
    bool WakaOptions::isEnabled() const
    {
        return _isEnabled;
    }
    bool WakaOptions::inStatusBar() const
    {
        return _statusBarEnabled;
    }
    bool WakaOptions::hasKey() const
    {
        return !_apiKey.isEmpty();
    }
    QString WakaOptions::apiKey() const
    {
        return _apiKey;
    }
    QString WakaOptions::excludePattern() const
    {
        return _excludePattern;
    }

    void WakaOptions::setDebug(bool val)
    {
        _isDebug = val;
    }
    void WakaOptions::setEnabled(bool val)
    {
        _isEnabled = val;
    }
    void WakaOptions::setStatusBar(bool val)
    {
        _statusBarEnabled = val;
        emit inStatusBarChanged();
    }
    void WakaOptions::setApiKey(const QString &val)
    {
        _apiKey = val;
        emit apiKeyChanged();
    }
    void WakaOptions::setExcludePatern(const QString &val)
    {
        _excludePattern = val;
        emit ignorePaternChanged();
    }
} // namespace Wakatime::Internal
